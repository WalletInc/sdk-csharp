...
namespace WalletInc.Model
{
    ...
    /// SubscriptionFeature
    /// </summary>
    [DataContract(Name = "SubscriptionFeature")]
    public partial class SubscriptionFeature : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionFeature" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SubscriptionFeature() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionFeature" /> class.
        /// </summary>
        ...
        public SubscriptionFeature(double sortNum = default, string name = default, string slug = default, string maxVolume = default, string measurement = default, string description = default, string currentVolume = default, bool isExceeded = default, bool isInUse = default, bool isEnabled = default)
        {
            ...
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for SubscriptionFeature and cannot be null");
            }
            this.Name = name;
            // to ensure "measurement" is required (not null)
            if (measurement == null)
            {
                throw new ArgumentNullException("measurement is a required property for SubscriptionFeature and cannot be null");
            }
