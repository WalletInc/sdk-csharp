...
namespace WalletInc.Model
{
    ...
    public partial class WTVideoCreateParams : IValidatableObject
    {
        ...
        public WTVideoCreateParams(string title = default, string description = default, int orderNumber = default, string additionalInfoURL = default, string assetId = default, VideoProvider provider = default)
        {
