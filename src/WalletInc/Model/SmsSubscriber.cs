...
namespace WalletInc.Model
{
    ...
    public partial class SmsSubscriber : IValidatableObject
    {
        ...
        public SmsSubscriber(string mobileNumber = default, string optInSource = default, string disclosureVersion = default, AmenityId id = default, DateTime createdAt = default, DateTime updatedAt = default, bool isActive = default, string merchantID = default)
        {
