...
namespace WalletInc.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WTVirtualBusinessCardCreateParams")]
    public partial class WTVirtualBusinessCardCreateParams : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WTVirtualBusinessCardCreateParams" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WTVirtualBusinessCardCreateParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WTVirtualBusinessCardCreateParams" /> class.
        /// </summary>
        ...
        public WTVirtualBusinessCardCreateParams(string firstName = default, string lastName = default, string emailAddress = default, string designation = default, string phoneNumber = default, string introduction = default, string instagram = default, string facebook = default, string youTube = default, string twitter = default, string linkedIn = default, string tikTok = default, string whatsApp = default, string avatarURL = default)
        {
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for WTVirtualBusinessCardCreateParams and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastName" is required (not null)
            if (lastName == null)
            {
                throw new ArgumentNullException("lastName is a required property for WTVirtualBusinessCardCreateParams and cannot be null");
            }
            this.LastName = lastName;
            // to ensure "emailAddress" is required (not null)
            if (emailAddress == null)
            {
                throw new ArgumentNullException("emailAddress is a required property for WTVirtualBusinessCardCreateParams and cannot be null");
            }
            this.EmailAddress = emailAddress;
            // to ensure "designation" is required (not null)
            if (designation == null)
            {
                throw new ArgumentNullException("designation is a required property for WTVirtualBusinessCardCreateParams and cannot be null");
            }
            this.Designation = designation;
            // to ensure "phoneNumber" is required (not null)
            if (phoneNumber == null)
            {
                throw new ArgumentNullException("phoneNumber is a required property for WTVirtualBusinessCardCreateParams and cannot be null");
            }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WTVirtualBusinessCardCreateParams {\n");
