...
namespace WalletInc.Model
{
    ...
    public partial class A2PSoleProprietorSubmission : IValidatableObject
    {
        ...
        public A2PSoleProprietorSubmission(string firstName = default, string lastName = default, string email = default, string businessName = default, BusinessTypeSoleProprietorship businessType = default, string address1 = default, string address2 = default, string city = default, string state = default, string postalCode = default, string country = default, string phoneNumber = default, bool isTwilioTermsRead = default, bool isWalletSmsTermsRead = default, bool isPricingUnderstood = default, bool isPrivacyAndTosPresent = default, string privacyPolicyUrl = default, bool willObtainConsent = default, bool willHonorOptOut = default, bool willFollowContentRules = default, bool willComplyLawAndHours = default, bool infoIsAccurate = default, string verificationMobile = default)
        {
