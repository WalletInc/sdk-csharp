...
namespace WalletInc.Model
{
    ...
    public partial class A2PSoleProprietorSubmission : IValidatableObject
    {
        ...
        public A2PSoleProprietorSubmission(string firstName = default, string lastName = default, string email = default, string businessName = default, BusinessTypeSoleProprietorship businessType = default, string address1 = default, string address2 = default, string city = default, string state = default, string postalCode = default, string country = default, string phoneNumber = default, bool isTwilioTermsRead = default, bool isPrivacyPolicyOnWebsite = default, bool isTosOnWebsite = default, bool isStopUnderstood = default, bool isManualRead = default, bool isCtiaShortCodeRead = default, bool isStandardsUnderstood = default, bool isShortCodeUnderstood = default, bool isOptInOutUnderstood = default, bool isShortCodeTransferUnderstood = default, bool isPricingUnderstood = default, bool isShortCodeTimelineUnderstood = default, string verificationMobile = default)
        {
