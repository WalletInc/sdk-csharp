...
namespace WalletInc.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WTServiceUpdateParams")]
    public partial class WTServiceUpdateParams : IValidatableObject
    {
        /// <summary>
        /// Defines TaxBehavior
        /// </summary>
        ...
        */
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WTServiceUpdateParams" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WTServiceUpdateParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WTServiceUpdateParams" /> class.
        /// </summary>
        ...
        public WTServiceUpdateParams(string title = default, string description = default, string displayedPrice = default, int orderNumber = default, string mediaURL = default, string additionalInfoURL = default, int priceAmount = default, string currency = default, bool isBuyable = default, TaxBehaviorEnum? taxBehavior = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for WTServiceUpdateParams and cannot be null");
            }
            this.Title = title;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for WTServiceUpdateParams and cannot be null");
            }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WTServiceUpdateParams {\n");
