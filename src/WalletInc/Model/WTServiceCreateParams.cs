...
namespace WalletInc.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WTServiceCreateParams")]
    public partial class WTServiceCreateParams : IValidatableObject
    {
        /// <summary>
        /// Defines TaxBehavior
        /// </summary>
        ...
        */
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WTServiceCreateParams" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WTServiceCreateParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WTServiceCreateParams" /> class.
        /// </summary>
        ...
        public WTServiceCreateParams(string title = default, string description = default, string displayedPrice = default, int orderNumber = default, string mediaURL = default, string additionalInfoURL = default, int priceAmount = default, string currency = default, bool isBuyable = default, TaxBehaviorEnum? taxBehavior = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for WTServiceCreateParams and cannot be null");
            }
            this.Title = title;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for WTServiceCreateParams and cannot be null");
            }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WTServiceCreateParams {\n");
