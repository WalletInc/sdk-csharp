...
namespace WalletInc.Model
{
    ...
    public partial class WTVirtualBusinessCardUpdateParams : IValidatableObject
    {
        ...
        public WTVirtualBusinessCardUpdateParams(string firstName = default, string lastName = default, string emailAddress = default, string designation = default, string phoneNumber = default, string introduction = default, string instagram = default, string facebook = default, string youTube = default, string twitter = default, string linkedIn = default, string tikTok = default, string whatsApp = default, string avatarURL = default)
        {
