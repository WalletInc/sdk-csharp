...
namespace WalletInc.Model
{
    ...
    /// A2PPublicSubmission
    /// </summary>
    [DataContract(Name = "A2PPublicSubmission")]
    public partial class A2PPublicSubmission : IValidatableObject
    {
        ...
        public BusinessClassificationPublic BusinessClassification { get; set; }
        ...
        /// </summary>
        [DataMember(Name = "stockExchange", IsRequired = true, EmitDefaultValue = true)]
        public BusinessStockExchanges StockExchange { get; set; }
        /// <summary>
        /// Initializes a new instance of the <see cref="A2PPublicSubmission" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected A2PPublicSubmission() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="A2PPublicSubmission" /> class.
        /// </summary>
        ...
        public A2PPublicSubmission(string firstName = default, string lastName = default, string email = default, BusinessClassificationPublic businessClassification = default, BusinessIndustry businessIndustry = default, BusinessRegistrationIdentifier taxIDType = default, string taxID = default, string websiteURL = default, string socialMediaURL = default, List<BusinessRegionsOfOperation> regionsOfOperation = default, bool messagingVolumeHigh = default, string jobTitle = default, JobPosition jobPosition = default, A2PBillingConsent billingConsent = default, string businessName = default, BusinessType businessType = default, string address1 = default, string address2 = default, string city = default, string state = default, string postalCode = default, string country = default, string phoneNumber = default, bool isTwilioTermsRead = default, bool isWalletSmsTermsRead = default, bool isPricingUnderstood = default, bool isPrivacyAndTosPresent = default, string privacyPolicyUrl = default, bool willObtainConsent = default, bool willHonorOptOut = default, bool willFollowContentRules = default, bool willComplyLawAndHours = default, bool infoIsAccurate = default, string brandContactEmail = default, string stockTicker = default, BusinessStockExchanges stockExchange = default)
        {
            ...
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for A2PPublicSubmission and cannot be null");
            }
            this.FirstName = firstName;
            // to ensure "lastName" is required (not null)
            if (lastName == null)
            {
                throw new ArgumentNullException("lastName is a required property for A2PPublicSubmission and cannot be null");
            }
            this.LastName = lastName;
            // to ensure "email" is required (not null)
            if (email == null)
            {
                throw new ArgumentNullException("email is a required property for A2PPublicSubmission and cannot be null");
            }
            this.Email = email;
            ...
            if (taxID == null)
            {
                throw new ArgumentNullException("taxID is a required property for A2PPublicSubmission and cannot be null");
            }
            this.TaxID = taxID;
            // to ensure "websiteURL" is required (not null)
            if (websiteURL == null)
            {
                throw new ArgumentNullException("websiteURL is a required property for A2PPublicSubmission and cannot be null");
            }
            this.WebsiteURL = websiteURL;
            // to ensure "socialMediaURL" is required (not null)
            if (socialMediaURL == null)
            {
                throw new ArgumentNullException("socialMediaURL is a required property for A2PPublicSubmission and cannot be null");
            }
            this.SocialMediaURL = socialMediaURL;
            // to ensure "regionsOfOperation" is required (not null)
            if (regionsOfOperation == null)
            {
                throw new ArgumentNullException("regionsOfOperation is a required property for A2PPublicSubmission and cannot be null");
            }
            ...
            if (jobTitle == null)
            {
                throw new ArgumentNullException("jobTitle is a required property for A2PPublicSubmission and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("businessName is a required property for A2PPublicSubmission and cannot be null");
            }
            ...
            if (address1 == null)
            {
                throw new ArgumentNullException("address1 is a required property for A2PPublicSubmission and cannot be null");
            }
            this.Address1 = address1;
            // to ensure "city" is required (not null)
            if (city == null)
            {
                throw new ArgumentNullException("city is a required property for A2PPublicSubmission and cannot be null");
            }
            this.City = city;
            // to ensure "state" is required (not null)
            if (state == null)
            {
                throw new ArgumentNullException("state is a required property for A2PPublicSubmission and cannot be null");
            }
            this.State = state;
            // to ensure "postalCode" is required (not null)
            if (postalCode == null)
            {
                throw new ArgumentNullException("postalCode is a required property for A2PPublicSubmission and cannot be null");
            }
            this.PostalCode = postalCode;
            // to ensure "country" is required (not null)
            if (country == null)
            {
                throw new ArgumentNullException("country is a required property for A2PPublicSubmission and cannot be null");
            }
            this.Country = country;
            // to ensure "phoneNumber" is required (not null)
            if (phoneNumber == null)
            {
                throw new ArgumentNullException("phoneNumber is a required property for A2PPublicSubmission and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("brandContactEmail is a required property for A2PPublicSubmission and cannot be null");
            }
            this.BrandContactEmail = brandContactEmail;
            // to ensure "stockTicker" is required (not null)
            if (stockTicker == null)
            {
                throw new ArgumentNullException("stockTicker is a required property for A2PPublicSubmission and cannot be null");
            }
        ...
        */
        ...
        /// </summary>
        [DataMember(Name = "brandContactEmail", IsRequired = true, EmitDefaultValue = true)]
        public string BrandContactEmail { get; set; }

        /// <summary>
        /// Gets or Sets StockTicker
        /// </summary>
        [DataMember(Name = "stockTicker", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class A2PPublicSubmission {\n");
