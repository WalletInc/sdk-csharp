...
namespace WalletInc.Model
{
    ...
    public partial class VirtualBusinessCard : IValidatableObject
    {
        ...
        public VirtualBusinessCard(string firstName = default, string lastName = default, string emailAddress = default, string designation = default, string phoneNumber = default, string introduction = default, string instagram = default, string facebook = default, string youTube = default, string twitter = default, string linkedIn = default, string tikTok = default, string whatsApp = default, string avatarURL = default, AmenityId id = default, DateTime createdAt = default, DateTime updatedAt = default, bool isActive = default, string merchantID = default)
        {
