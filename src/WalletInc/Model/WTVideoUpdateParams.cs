...
namespace WalletInc.Model
{
    ...
    /// WTVideoUpdateParams
    /// </summary>
    [DataContract(Name = "WTVideoUpdateParams")]
    public partial class WTVideoUpdateParams : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WTVideoUpdateParams" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WTVideoUpdateParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WTVideoUpdateParams" /> class.
        /// </summary>
        ...
        public WTVideoUpdateParams(string title = default, string description = default, int orderNumber = default, string additionalInfoURL = default, string assetId = default)
        {
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for WTVideoUpdateParams and cannot be null");
            }
            this.Title = title;
            // to ensure "description" is required (not null)
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for WTVideoUpdateParams and cannot be null");
            }
        ...
        */
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WTVideoUpdateParams {\n");
