...
namespace WalletInc.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "2.1.603";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/2.1.603/csharp");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 2.1.603\n";
            report += "    SDK Package Version: 2.1.603\n";
