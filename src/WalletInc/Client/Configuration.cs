...
namespace WalletInc.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "2.1.602";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/2.1.602/csharp");
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 2.1.602\n";
            report += "    SDK Package Version: 2.1.602\n";
