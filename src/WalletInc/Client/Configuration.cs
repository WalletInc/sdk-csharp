...
namespace WalletInc.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public const string Version = "2.38.3";
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/2.38.3/csharp");
        ...
        public Configuration(
            ...
            string basePath = "https://api.wall.et") : this()
        {
        ...
        {
            string report = "C# SDK (WalletInc) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 2.38.3\n";
            report += "    SDK Package Version: 2.38.3\n";
